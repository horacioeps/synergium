...
Últimas implementaciones de Forms hechas desde el repo maestro maestro; a partir de ahora el canónico es **este** repo (`synergium` → `forms/`).
...
| Código/docs canónicos | **Aquí:** `forms/` |
