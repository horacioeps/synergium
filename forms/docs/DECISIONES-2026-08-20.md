...
- Google Form: ver `comunidad/casos/2026-08-14-formulario-matching/enlaces-vivos.md`
- Sync: `scripts/synergium_forms_sheet_sync.py` · log VPS `~/synergium-forms/logs/sheet-sync.log`
