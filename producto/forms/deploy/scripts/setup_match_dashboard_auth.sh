...
AUTH_USER="${SYNERGIUM_MATCH_DASHBOARD_USER:-synergium}"
AUTH_PASS="${SYNERGIUM_MATCH_DASHBOARD_PASSWORD:-}"
HTPASSWD="/etc/apache2/synergium-match-dashboard.htpasswd"
...
sudo htpasswd -bc "$HTPASSWD" "$AUTH_USER" "$AUTH_PASS"
