...
#
# Usage:
#   ops/scripts/vault_ssh_ro.sh ls [relpath]
#   ops/scripts/vault_ssh_ro.sh cat <relpath>
#   ops/scripts/vault_ssh_ro.sh find [find-args...]
#   ops/scripts/vault_ssh_ro.sh count-md
#   ops/scripts/vault_ssh_ro.sh get <relpath> <dest-local>
#   ops/scripts/vault_ssh_ro.sh sh '<remote read-only command>'
